...
<?php foreach($questions as $question): ?>
    ...
    <?php if($edit_delete == $_SESSION["username"]):?>
        <a href="user_editquestion.php?id=<?=$question['id']?>">Edit</a><br>
        <form action="user_deletequestion.php" method="POST" enctype="multipart/form-data">
    ...
    Comment: <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=htmlspecialchars($comment["commentText"],ENT_QUOTES,'UTF-8')?><br />
        ...
        <?php if($edit_delete == $_SESSION["username"]):?>
        <a href="user_editcomment.php?id=<?=$comment['id']?>">Edit Comment</a><br>
        <form action="user_deletecomment.php" method="POST" enctype="multipart/form-data">
