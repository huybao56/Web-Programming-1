...
<body>
    <header class="container-fluid header-nav py-3 d-flex justify-content-between align-items-center">
        <h1 class="mb-0">Questions Web of User Home</h1>
        <nav>
            <ul class="nav">
                <li class="nav-item"><a class="nav-link" href="Userhome.php">Home</a></li>
                <li class="nav-item"><a class="nav-link" href="user_addquestions.php">Add Questions</a></li>
                <li class="nav-item"><a class="nav-link" href="user_contact.php">Contact Us</a></li>
